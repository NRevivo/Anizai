"""
Consensus Summary prompt — GPT-4o Consensus Bundling for Social Pulse (Section 4.2A).

Used by:
    - Polymarket (prediction market community comments)
    - HackerNews (story + top community comments)

Both sources share this prompt because the 11-field Consensus Bundle schema is
format-agnostic; the user prompt label ("Market question" vs "HackerNews story")
provides GPT-4o sufficient context to frame its consensus analysis correctly.
